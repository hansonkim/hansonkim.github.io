...
date: 2026-03-18T02:03:03+09:00
tags:
  - posts
  - AI
  - 개발도구
...
🔗 **[https://github.com/{user name}kim/claude-code-blog-hook](https://github.com/{user name}kim/claude-code-blog-hook)**
...
```
/Users/{user name}/blogs/              # 블로그 작성 디렉토리
├── .hooks/
...
~/workspace/{user name}kim.github.io/  # GitHub Pages 저장소
└── src/posts/                    # 배포 대상
    └── *.md                      # 최종 파일
```
...
{
  "hooks": {
    "post-write": "/Users/{user name}/blogs/.hooks/post-write-hook.js"
  }
}
```
...
```bash
claude-code config set hooks.post-write "/Users/{user name}/blogs/.hooks/post-write-hook.js"
```
...
Processing: my-new-post.md
  ...
  → Saved to: /Users/{user name}/blogs/_site/my-new-post.md
...
# 디렉토리 전체
node .hooks/post-write-hook.js /Users/{user name}/blogs
```
...
# 수동 push 테스트
cd ~/workspace/{user name}kim.github.io
...
```bash
# Repository clone
git clone https://github.com/{user name}kim/claude-code-blog-hook.git
...
- **GitHub Repository**: [https://github.com/{user name}kim/claude-code-blog-hook](https://github.com/{user name}kim/claude-code-blog-hook)
